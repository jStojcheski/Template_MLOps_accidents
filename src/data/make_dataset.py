...
def main(input_filepath, output_filepath):
    ...
    output_filepath = click.prompt(
        "Enter the file path for the output preprocessed data (e.g., output/preprocessed_data.csv)", type=click.Path()
    )

    process_data(
        input_filepath_users, input_filepath_caract, input_filepath_places, input_filepath_veh, output_filepath
    )
